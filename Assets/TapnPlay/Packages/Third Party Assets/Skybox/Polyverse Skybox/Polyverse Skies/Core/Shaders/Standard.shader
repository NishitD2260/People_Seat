...
Shader "BOXOPHOBIC/Polyverse Skies/Standard"
{
	Properties
	{
		...
		_CloudsHeight("Clouds Height", Range( -1 , 0.75)) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float staticSwitch947 = saturate( ( ( dotResult732 - temp_output_7_0_g5 ) / ( -( 1.0 - _StarsSunMask ) - temp_output_7_0_g5 ) ) );
				#else
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult288 = lerp( _EquatorColor , lerpResult180 , pow( saturate( ( ( abs( VertexPos1239.y ) - temp_output_7_0_g6 ) / ( _EquatorHeight - temp_output_7_0_g6 ) ) ) , ( 1.0 - _EquatorSmoothness ) ));
				...
				float dotResult89 = dot( normalizeResult1163 , ((texCUBENode41).rgb*2.0 + -1.0) );
				#ifdef _CLOUDSLITBYSUN_ON
				float staticSwitch391 = saturate( (dotResult89*0.5 + 0.5) );
				#else
				...
				float lerpResult678 = lerp( saturate( pow( ( ( temp_output_314_0 - temp_output_7_0_g4 ) / ( _FogHeight - temp_output_7_0_g4 ) ) , ( 1.0 - _FogSmoothness ) ) ) , 0.0 , _FogFill);
...
/*ASEBEGIN
Version=18908
1920;0;1920;1029;1877.492;-1002.452;2.730911;True;False
...
Node;AmplifyShaderEditor.Vector3Node;938;-896,-128;Half;False;Global;GlobalSunDirection;GlobalSunDirection;38;0;Create;True;0;0;0;False;0;False;0,0,0;-0.4798,0.8480482,0.224959;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;1292;0,-3328;Inherit;False;Remap To 0-1;-1;;6;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1291;3328,-1792;Inherit;False;Remap To 0-1;-1;;5;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;-1;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;126;2304,2080;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;996;2176,320;Half;False;Property;_SunIntensity;Sun Intensity;36;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;1289;2560,2080;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;2;False;2;FLOAT;-1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;1281;2688,32;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1045;2176,1408;Half;False;Property;_MoonIntensity;Moon Intensity;42;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;1290;3584,1920;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1287;-320,3120;Inherit;False;Remap To 0-1;-1;;4;5eda8a2bb94ebef4ab0e43d19291cd8b;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E1D8E9436D9D4B15AF3E35C7A40B1AE906B57334